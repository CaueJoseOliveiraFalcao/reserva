    ...
    return(
        <header style={{backgroundColor : '#6E1013'}} className=" w-full flex justify-between items-center h-24 p-1">
            ...
            <div>
                ...
                <a href="/table/"  className="p-3 cursor-pointer hover:opacity-95 text-xl rounded-md ml-3" style={{backgroundColor : "white" , color : '#E84A69' }}>Mesas</a>
                <a href="/validate-reservation/" className="p-3 cursor-pointer text-xl hover:opacity-95 ml-3 rounded-md" style={{backgroundColor : "#E84A69" }}>Validar Entrada</a>
            </div>
        </header>
    )
}